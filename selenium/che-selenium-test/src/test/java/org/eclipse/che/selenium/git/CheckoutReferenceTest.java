...
public class CheckoutReferenceTest {
    ...
    private static final String BRANCH_DETACHED_HASH  = "(detached from 005ae81917608ea7d18f178a0231f285d3357106)";
    ...
    public void checkCheckoutReference() throws Exception {
        ...
        importProjectFromRemoteRepo("git@github.com:" + gitHubUsername + "/testRepo-2.git",
                                    PROJECT_NAME);
        ...
        menu.runCommand(TestMenuCommandsConstants.Git.GIT, TestMenuCommandsConstants.Git.CHECKOUT_REFERENCE);
