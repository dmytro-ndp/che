...
public class CheckoutToRemoteBranchTest {
    private static final String PROJECT_NAME         = NameGenerator.generate("CheckoutToRemoteBranchTest-", 4);
    private static final String PROJECT_NAME2        = NameGenerator.generate("CheckoutToRemoteBranchTest2-", 4);
    ...
    private static final String GIT_STATUS_MESS      = " On branch " + SECOND_BRANCH + "\n" +
    ...
    public void checkoutToRemoteBranchTest() throws Exception {
        ...
        projectExplorer.openItemByPath(PROJECT_NAME + "/src/main/java/helloworld/GreetingController.java");
        ...
        String pushedMessage = "Successfully pushed to git@github.com:" + gitHubUsername + "/springProjectWithSeveralBranches.git";
        ...
        projectExplorer.expandPathInProjectExplorerAndOpenFile(PROJECT_NAME2 + "/src/main/java/helloworld", "GreetingController.java");
        loader.waitOnClosed();
        projectExplorer.expandPathInProjectExplorerAndOpenFile(PROJECT_NAME2 + "/src/main/webapp", 3, "index.jsp");
        loader.waitOnClosed();
        projectExplorer.openItemByVisibleNameInExplorer("GreetingController.java");
        editor.waitTextIntoEditor(uniqueValue);
        editor.closeFileByNameWithSaving("GreetingController");
