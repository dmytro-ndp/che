...
public class FetchUpdatesAndMergeRemoteBranchIntoLocalTest {
    ...
    private static final String MESSAGE_FOR_CHANGE_CONTENT = "//" + String.valueOf(System.currentTimeMillis()) + "_change_content";
    ...
    public void tearDown() throws Exception {
        ...
        gitHubClientService.hardResetHeadToCommit(
                "testRepo-1",
                "e50be4bbcc4b126fb3af29e29c32a95c7131eb31",
                gitHubUsername,
                gitHubPassword);
    }
    ...
    public void fetchUpdatesAndMergeRemoteBranch() {
        ...
        projectExplorer.openItemByPath(PROJECT_1 + "/src/main/java/commenttest/" + FILE_FOR_CHANGE_2 + ".java");
        ...
        menu.runAndWaitCommand(TestMenuCommandsConstants.Git.GIT, TestMenuCommandsConstants.Git.REMOVE_FROM_INDEX);
        ...
        projectExplorer.openItemByPath(PROJECT_2 + "/src/main/java/commenttest/" + FILE_FOR_CHANGE_2 + ".java");
        editor.waitTextNotPresentIntoEditor("//" + MESSAGE_FOR_CHANGE_CONTENT);
        projectExplorer.waitItemInVisibleArea(NEW_FILE_NAME);
