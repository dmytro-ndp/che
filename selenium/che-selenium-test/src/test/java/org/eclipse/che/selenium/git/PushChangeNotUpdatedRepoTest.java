...
public class PushChangeNotUpdatedRepoTest {
    ...
    private final static String FILE_FOR_CHANGED_2 = "PushChangeNonUpdatedRepoTest.txt";
    ...
    public void pushNoneUpdateTest() {
        ...
        notifications.waitProgressPopupPanelClose();
        consoles.waitProcessInProcessConsoleTree("Git push");
        git.waitGitStatusBarWithMess("failed to push 'master -> master' to 'git@github.com:" + gitHubUsername + "/testRepository.git'." +
        ...
        events.clickProjectEventsTab();
        events.waitExpectedMessage("Pulled from git@github.com:" + gitHubUsername + "/testRepository.git");
