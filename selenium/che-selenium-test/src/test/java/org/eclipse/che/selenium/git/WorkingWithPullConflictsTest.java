...
public class WorkingWithPullConflictsTest {
    ...
    private static final String CHANGE_STRING_1 = "//first_change" + String.valueOf(System.currentTimeMillis());
    private static final String CHANGE_STRING_2 = "//second_change";

    private static final String headConfPrefixConfMess = "<<<<<<< HEAD\n" +
                                                         "//second_change\n" +
                                                         "=======\n" +
                                                         CHANGE_STRING_1 + "\n" +
                                                         ">>>>>>>";
    ...
    public void pullConflictsTest() {
        ...
        projectExplorer.openItemByPath(PROJECT_2 + "/src/main/java/commenttest/" + fileForChange + ".java");
        ...
        projectExplorer.quickExpandWithJavaScript();
        projectExplorer.openItemByPath(PROJECT_1 + "/src/main/java/commenttest/" + fileForChange + ".java");
